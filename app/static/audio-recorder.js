class AudioRecorder extends HTMLElement {
    constructor() {
        ...
        this.shadowRoot.innerHTML = `
            ...
            <div>
                <div class="controls">
                    ...
                    <button class="transcript-btn" disabled>Transcript</button>
        ...
        this.transcriptBtn = this.shadowRoot.querySelector('.transcript-btn');
    ...
    setupEventListeners() {
        ...
        this.transcriptBtn.addEventListener('click', () => this.uploadAudio());
